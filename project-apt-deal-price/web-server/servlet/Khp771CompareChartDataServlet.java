...
@WebServlet(urlPatterns = { "/khp771/compare_chart_data" })
public class Khp771CompareChartDataServlet extends HttpServlet {
...
//		String region2 = URLDecoder.decode(req.getParameter("region2"), "UTF-8");
		...
		String path = String.format(
				...
				"http://127.0.0.1:5000/khp771/chart_deal_count",
