...
@WebServlet(urlPatterns = { "/khp771/size_deal_count" })
public class Khp771SizeDealCountServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

		{
			...
			String path = "http://127.0.0.1:5000/khp771/size_deal_count?region=" + region; 
			...
			if (status == 200) {
				...
				req.setAttribute("size_deal_count", sdcList);
...
//		out.println(result);
		...
		// 브라우저에게 응답
		RequestDispatcher rd = req.getRequestDispatcher("/WEB-INF/views/khp-size-deal-count-list.jsp");
		rd.forward(req, resp);
