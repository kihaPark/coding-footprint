...
@WebServlet(urlPatterns = { "/khp771/compare_price_chart" })
public class Khp771ComparePriceChartStartServlet extends HttpServlet {
...
//		out.println(result);
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/khp-compare-price-chart-view.jsp");
